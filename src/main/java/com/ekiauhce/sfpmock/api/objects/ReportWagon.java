...
public class ReportWagon {
    ...
    @JsonProperty("Issues")
    public List<IssueReport> issues = null;
    @JsonProperty("LastAxle")
    public DateSender lastAxle;
    ...
    public static ReportWagon mock(Random random, DocWagon wagon) {
        ReportWagon reportWagon = new ReportWagon();

        reportWagon.setAxlesCount(random.nextInt()); //
        reportWagon.setCargoName(wagon.getSkunNumber()); //
