...
public class Report {
    ...
    public StartedTime startedTime;
    ...
    public TrainDocumentId trainDocumentId;
    ...
    public static Report mock(long trainDocumentId, int trainNumber) {
        Random random = new Random();

        Report report = new Report();

        report.setId(Id.mock());
        ...
        report.setStartedTime(StartedTime.mock());
        report.setState(2);
        report.setSupervisor(null);
        report.setTechnovisorReportId(null);
        report.setTrainDocumentId(TrainDocumentId.mock(trainDocumentId)); // matches to doc's
        ...
        report.setWagonsCount(reportWagons.size());
